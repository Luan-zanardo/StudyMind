...
import { 
  ...
  Layout, BarChart2, LogOut, BookOpen
} from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {activeTab === "analysis" ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="w-full mb-10 lg:mb-0 lg:col-span-4 lg:sticky lg:top-36">
                  ...
                  <section className="space-y-8">
                    ...
                    <div className="grid gap-6">
                      ...
                      {data.resumo.map((item: any, i: number) => (
                        ...
                        <div
                          key={i}
                          className="bg-white/[0.03] border border-white/5 p-8 rounded-[2.5rem]"
                        >
